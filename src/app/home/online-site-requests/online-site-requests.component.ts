...
@Component({
  selector: 'app-online-site-requests',
  templateUrl: './online-site-requests.component.html',
  styleUrls: ['./online-site-requests.component.css'],
})
export class OnlineSiteRequestsComponent implements OnInit {
