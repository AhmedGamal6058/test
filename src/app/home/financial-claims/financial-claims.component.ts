...
@Component({
  selector: 'app-financial-claims',
  templateUrl: './financial-claims.component.html',
  styleUrls: ['./financial-claims.component.css'],
})
export class FinancialClaimsComponent implements OnInit {
